...
if (isset($_GET['action']) && $_GET['action'] == 'hapus' && isset($_GET['id'])) {
    ...
    $delete_query = "DELETE FROM penyimpanan_buku WHERE id = '$id_to_delete'";
    $conn->query($delete_query);
}

$query = "SELECT id, title, author, published_year, isbn FROM penyimpanan_buku";
...
<head>
    ...
    <title>Perpustakaan Muhammad Afip</title>
    <style>
         body {
