...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_query = "UPDATE penyimpanan_buku SET title = '$new_title', author = '$new_author', published_year = '$new_publish_year', isbn = '$new_isbn' WHERE id = '$id_to_update'";
...
if (isset($_GET['id'])) {
    ...
    $edit_query = "SELECT id, title, author, published_year, isbn FROM penyimpanan_buku WHERE id = '$id_to_edit'";
...
<body>
    ...
    <header>
        <h1>PERPUSTAKAAN MUHAMMAD AFIP</h1>
    </header>
